...
tss <- .getTSS_from_bam(bam.files[1:2], BSgenome.Scerevisiae.UCSC.sacCer3, sample.labels=c("S01","S02"),filetype= "bam",
                        sequencingQualityThreshold = 10,
                        mappingQualityThreshold = 20,
                        removeNewG = TRUE,
                        correctG = TRUE)
tss <- .getTSS_from_bam(bam.files, BSgenome.Hsapiens.UCSC.hg19, sample.labels=c("S01","S02"),filetype= "bamPairedEnd",
                        sequencingQualityThreshold = 10,
                        mappingQualityThreshold = 20,
                        removeNewG = TRUE,
                        correctG = TRUE)
...
setwd("~/Desktop/TSSr_data")
bam.files = list.files()
###################################################################################################################
##read bam, bamPairedEnd
###################################################################################################################
.getTSS_from_bam <- function(bam.files, genome, sample.labels, filetype,sequencingQualityThreshold = 10, mappingQualityThreshold = 20,removeNewG = TRUE,correctG = TRUE){
