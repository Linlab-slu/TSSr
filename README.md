...
* Input data files
  ...
  A subset of Saccharomyces cerevisiae TSS data generated by (Lu and Lin 2019) will be used in the following demonstrations of TSSr workflow (Available at http://zlinlab.org/TSSr.html). 
...
* To creat a new TSSr object, users will need to generate a new input files "inputFiles" that contains the path and file names of input files. We provided for example bam files. The four example bam files can be downloaded from https://linlabslu.s3.us-east-2.amazonaws.com/TSSr/S01.sorted.bam, https://linlabslu.s3.us-east-2.amazonaws.com/TSSr/S02.sorted.bam, https://linlabslu.s3.us-east-2.amazonaws.com/TSSr/S03.sorted.bam, https://linlabslu.s3.us-east-2.amazonaws.com/TSSr/S04.sorted.bam.
