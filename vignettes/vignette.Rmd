...
![01_TSS_correlation_plot_of_all_samples](./figures/01_TSS_correlation_plot_of_all_samples.png){width=50%}

        > plotTssPCA(myTSSr, TSS.threshold=10)
    
![02_PCA_plot](./figures/02_PCA_plot.png){width=50%}
...
![03_Interquantile_plot_of_ALL_samples](./figures/03_Interquantile_plot_of_ALL_samples.png){width=75%}

        > plotShape(myTSSr)
    
![04_Shape_plot_of_ALL_samples](./figures/04_Shape_plot_of_ALL_samples.png){width=75%}
...
![05_Volcano_plot](./figures/05_Volcano_plot.png){width=50%}
...
![06_TSS_graphs](./figures/06_TSS_graphs.png){width=50%}
